...
export class InitialMigration1678561413278 implements MigrationInterface {
    name = 'InitialMigration1678561413278'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_technologies" ("id" SERIAL NOT NULL, "addedAt" date NOT NULL DEFAULT now(), "userId" integer, "technologyId" integer, CONSTRAINT "PK_958d4d90a76dec48d6088a3394b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users_projects_team" ("id" SERIAL NOT NULL, "waiting" boolean NOT NULL DEFAULT true, "addedAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "projectId" integer, "userId" integer, CONSTRAINT "PK_c09841cb9e52e644a928f21073f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "projects_technologies" ("id" SERIAL NOT NULL, "addedAt" date NOT NULL DEFAULT now(), "projectId" integer, "technologyId" integer, CONSTRAINT "PK_0216cd62ab5f3228a8efc1f31cf" PRIMARY KEY ("id"))`);
