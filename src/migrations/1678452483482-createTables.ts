...
export class createTables1678452483482 implements MigrationInterface {
    name = 'createTables1678452483482'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_projects_team" ("id" SERIAL NOT NULL, "waiting" boolean NOT NULL DEFAULT true, "addedAt" date NOT NULL DEFAULT now(), "projectId" integer, "userId" integer, CONSTRAINT "PK_c09841cb9e52e644a928f21073f" PRIMARY KEY ("id"))`);
