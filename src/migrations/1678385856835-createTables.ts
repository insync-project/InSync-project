...
export class createTables1678385856835 implements MigrationInterface {
    name = 'createTables1678385856835'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "projects_technologies" ("id" SERIAL NOT NULL, "addedAt" date NOT NULL DEFAULT now(), "userId" integer, "technologyId" integer, CONSTRAINT "PK_0216cd62ab5f3228a8efc1f31cf" PRIMARY KEY ("id"))`);
